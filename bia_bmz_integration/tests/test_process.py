...
datasets = {"S-BIAD144+S-BIAD916":
("https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/23_low.ome.zarr/0","https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/23_high.ome.zarr/0"),

"BIAD1026": ("https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/experimentA_01_WT_PDMP.ome.zarr/0", "https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/experimentA_01_WT_PDMP_cp_mask.ome.zarr/0" ),

"S-BIAD634":("https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/normal_26.ome.zarr/0", "https://uk1s3.embassy.ebi.ac.uk/bia-zarr-test/normal_26_mask.ome.zarr/0"),
}
